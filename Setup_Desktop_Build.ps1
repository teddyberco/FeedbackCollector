...
Write-Host "  1. Verify your src .env file has correct credentials" -ForegroundColor Gray
Write-Host "  2. Run Update_And_Rebuild.ps1 to build the executable" -ForegroundColor Gray
Write-Host "  3. After build, the ONLY .env file is next to FeedbackCollector.exe" -ForegroundColor Gray
Write-Host ""
